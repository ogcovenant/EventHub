    ...
    <>
      <Flex justifyContent={"center"}>
        ...
        <Box backgroundColor={"#F8F8FA"} height={"100vh"} width={{ base: "100%" }} p={10} display={"flex"} flexDirection={"column"} justifyContent={"center"} alignItems={"center"}>
          ...
          <Text mt={3}>Or</Text>
          <Button width={{ base:"100%", sm:"75%", md:"50%" }} fontWeight={100} p={2} border={"1px solid #687C94"} backgroundColor={"white"} color={"#7848F4"} _hover={{backgroundColor: "white", color:"#7848F4"}} mt={5} as={"button"} type="submit"><FcGoogle />&nbsp;Continue with Google</Button>
